...
curl -k --silent -w '\n' -X POST -H "Content-Type: application/json" -d '{"clientID": "1", "firstName": "Patrick", "lastName": "Olsen", "streetAddress": "Kastrupvej 2A", "City": "KBH"}' https://localhost:6000/clients &
sleep 1
echo "[32mPOST[0m Client 2:"
curl -k --silent -w '\n' -X POST -H "Content-Type: application/json" -d '{"clientID": "2", "firstName": "John", "lastName": "Pedersen", "streetAddress": "Fasanvej 12", "City": "Frederiksberg"}' https://localhost:6000/clients &
sleep 1
echo "=========================================================="
...
curl -k --silent -w '\n' -X PUT -H "Content-Type: application/json" -d '{"firstName": "CHANGED NAME", "lastName": "Olsen", "streetAddress": "Kastrupvej 2A", "City": "KBH"}' https://localhost:6000/clients/1 &
sleep 1
...
curl -k --silent -w '\n' -X DELETE https://localhost:6000/clients/2 &
sleep 1
...
curl --silent -w '\n' -k -X PUT -H "Content-Type: application/json" -d '{"date": "24122021", "hotelName": "CHANGED HOTEL", "price": "2300", "balance": "2"}' https://localhost:6000/reservations/100 &
sleep 1
...
curl -k --silent -w '\n' -X DELETE https://localhost:6000/reservations/200 &
sleep 1
...
curl -k --silent -w '\n' https://localhost:6000/reservations &
sleep 1
echo "=========================================================="
