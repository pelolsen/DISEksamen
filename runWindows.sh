...
echo "LB-test 1:"
curl -k --silent https://localhost:6000 &
echo " "
sleep 1
echo "LB-test 2:"
curl -k --silent https://localhost:6000 &
...
curl -k --silent -X POST -H "Content-Type: application/json" -d '{"clientID": "1", "firstName": "Patrick", "lastName": "Olsen", "streetAddress": "Kastrupvej 2A", "City": "KBH"}' https://localhost:6000/clients &
echo " "
sleep 1
echo "[32mPOST[0m Client 2:"
curl -k --silent -X POST -H "Content-Type: application/json" -d '{"clientID": "2", "firstName": "John", "lastName": "Pedersen", "streetAddress": "Fasanvej 12", "City": "Frederiksberg"}' https://localhost:6000/clients &
echo " "
sleep 1
echo "=========================================================="
...
curl -k --silent https://localhost:6000/clients &
echo " "
sleep 1
echo "=========================================================="
...
curl -k --silent https://localhost:6000/clients/1 &
echo " "
sleep 1
echo "[35mGET[0m Client with clientID = 2:"
curl -k --silent https://localhost:6000/clients/2 &
echo " "
sleep 1
echo "=========================================================="
...
curl -k --silent -X PUT -H "Content-Type: application/json" -d '{"firstName": "CHANGED NAME", "lastName": "Olsen", "streetAddress": "Kastrupvej 2A", "City": "KBH"}' https://localhost:6000/clients/1 &
echo " "
sleep 1
...
curl -k --silent -X DELETE https://localhost:6000/clients/2 &
echo " "
sleep 1
...
curl -k --silent -X POST -H "Content-Type: application/json" -d '{"reservationID": "100", "clientID": "1", "date": "24122021", "hotelName": "Marriot", "price": "2300", "balance": "2"}' https://localhost:6000/reservations &
echo " "
sleep 1
echo "[32mPOST[0m Reservation 2:"
curl -k --silent -X POST -H "Content-Type: application/json" -d '{"reservationID": "200", "clientID": "2", "date": "01012022", "hotelName": "Holiday Inn", "price": "1400", "balance": "1000"}' https://localhost:6000/reservations &
echo " "
sleep 1
echo "=========================================================="
...
curl --silent -k https://localhost:6000/reservations &
echo " "
sleep 1
echo "=========================================================="
...
curl --silent -k https://localhost:6000/reservations/100 &
echo " "
sleep 1
echo "[35mGET[0m Reservation with reservationID = 200:"
curl --silent -k https://localhost:6000/reservations/200 &
echo " "
sleep 1
echo "=========================================================="
...
curl --silent -k -X PUT -H "Content-Type: application/json" -d '{"date": "24122021", "hotelName": "CHANGED HOTEL", "price": "2300", "balance": "2"}' https://localhost:6000/reservations/100 &
echo " "
sleep 1
...
curl -k --silent -X DELETE https://localhost:6000/reservations/200 &
echo " "
sleep 1
...
curl -k --silent https://localhost:6000/reservations &
echo " "
sleep 1
echo "=========================================================="
